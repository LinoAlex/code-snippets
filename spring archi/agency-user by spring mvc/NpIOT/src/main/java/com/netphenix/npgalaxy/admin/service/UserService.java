 ...
 */
package com.netphenix.npgalaxy.admin.service;

import com.netphenix.npgalaxy.admin.dao.UserDao;
import com.netphenix.npgalaxy.bean.AgencyBean;
...
import com.netphenix.npgalaxy.model.Client;
...
//    }
     ...
     public LoginUserBean authenicate(LoginUserBean userBean) {
        String agencyPath = userBean.getAgencyPath();
        VbUser user = null;
        if (agencyPath == null || agencyPath.equalsIgnoreCase("")) {
            ...
            Agency agency = userDao.findAgencyByPath(agencyPath);
            user = userDao.findUser(agencyPath, userName, agency);
        }
