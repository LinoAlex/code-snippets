...
public class Agency implements Serializable {
    ...
    public void setagencyDashiencePath(String agencyPath) {
    ...
    public String toString() {
        return "Agency{" + "id=" + id + ", agencyName=" + agencyName + ", description=" + description + ", status=" + status + ", email=" + email +", agencyPath=" + agencyPath + '}';
    }
